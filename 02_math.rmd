...
# 15 (i)
$$
T_{a+e} = E[Y_{1i}-Y_{0i}]=E[y_i\left(1\right)-y_i\left(0\right)]\\
For the sample, T_{a+e} =N^{-1}\sum^{N}_{i=1}[y_i\left(1\right)-y_i\left(0\right)]=\overline{y}\left(1\right)-\overline{y}\left(0\right)
$$
# 15 (ii)
